...
func init() {
	proto.RegisterType((*QueryPostsRequest)(nil), "alice.chain.blog.QueryPostsRequest")
	proto.RegisterType((*QueryPostsResponse)(nil), "alice.chain.blog.QueryPostsResponse")
}
...
var fileDescriptor_6e22cd6d352f3384 = []byte{
	...
	,
}
...
func (c *queryClient) Posts(ctx context.Context, in *QueryPostsRequest, opts ...grpc.CallOption) (*QueryPostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/alice.chain.blog.Query/Posts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Posts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alice.chain.blog.Query/Posts",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "alice.chain.blog.Query",
