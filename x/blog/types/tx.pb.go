...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "alice.chain.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "alice.chain.blog.MsgCreatePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x48, 0xcc, 0xc9, 0x4c, 0x4e,
	0xd5, 0x4b, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x03, 0x49, 0x29, 0x05, 0x73, 0xf1, 0xfa, 0x16, 0xa7,
	...
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/alice.chain.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/alice.chain.blog.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "alice.chain.blog.Msg",
